...
import com.stock_service.stock.infra.product.output.notify.MessageSender;
import com.stock_service.stock.infra.product.output.notify.ProductNotify;
import com.stock_service.stock.infra.product.output.persistence.IProductMapper;
import com.stock_service.stock.infra.product.output.persistence.IProductRepository;
import com.stock_service.stock.infra.product.output.persistence.ProductAdapter;
